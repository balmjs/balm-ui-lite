<template>
  <div class="page--notify">
    ...
    <h4>下面是一个示例</h4>
    <ui-button colored raised @click.native="$notify.add(options2)">带有头像和多个按钮的</ui-button>
    ...
    <ui-button colored raised @click.native="$notify.add(options6)">输入like关闭</ui-button>
